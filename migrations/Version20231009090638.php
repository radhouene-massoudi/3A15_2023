 ...
 */
final class Version20231009090638 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE category CHANGE id catid INT AUTO_INCREMENT NOT NULL');
        $this->addSql('ALTER TABLE category ADD PRIMARY KEY (catid)');
        $this->addSql('ALTER TABLE product DROP FOREIGN KEY FK_D34A04AD1CE52F7');
        $this->addSql('DROP INDEX IDX_D34A04AD1CE52F7 ON product');
        $this->addSql('ALTER TABLE product CHANGE catgory_id idcat INT DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX `PRIMARY` ON category');
        $this->addSql('ALTER TABLE category CHANGE catid id INT AUTO_INCREMENT NOT NULL');
        ...
        $this->addSql('ALTER TABLE product CHANGE idcat catgory_id INT DEFAULT NULL');
